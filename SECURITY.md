...
*spoilr* resolves image URLs provided by the user and displays the fetched image in the browser. It should not execute decoded content, inject decoded values as HTML, or send decoded values anywhere except the Jigsaw Explorer fetch endpoint used to display the image.
